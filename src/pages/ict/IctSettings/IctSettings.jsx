...
const IctSettings = () => {
  ...
  const handlePasswordChange = async (e) => {
    ...
    const confirmation = await showAlert.confirm(
      "Change Password",
      "Are you sure you want to update your ICT administrator password?",
      "Yes, Change Password",
      "Cancel"
    );
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_LARAVEL_API}/ict/settings/change-password`,
        {
          method: "PUT",
          headers: {
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          showAlert.success(
            "Password Updated",
            "Your ICT administrator password has been updated."
          );
        }, 400);
      ...
      console.error("ICT password change error:", error);
      showAlert.close();
      showAlert.error(
        "Network Error",
        ...
        <div className="d-flex flex-column flex-md-row justify-content-center align-items-center mb-3">
          ...
          <div className="text-center text-md-start">
            <h1 className="h3 mb-1 fw-bold" style={{ color: BRAND.primary }}>
              ICT Security Settings
            </h1>
            <p className="text-muted mb-0">
              {user?.email || "No email provided"} • Credentials only
            </p>
            <small className="text-muted">
              Personal information changes are restricted
            </small>
          </div>
        </div>
      </div>
        ...
        <div className="col-12 col-lg-9">
          ...
          >
            <div className="card-header bg-transparent border-0 py-3 px-4">
              <div className="d-flex align-items-center">
                ...
                <div>
                  ...
                  <small className="text-muted">
                    Only credential updates are allowed
                  </small>
                </div>
              </div>
            </div>
            ...
            <div className="card-body p-4">
              ...
              >
                <strong>Administrator Note:</strong> Personal details are locked
                for ICT administrators. Only password changes are permitted.
              </div>
